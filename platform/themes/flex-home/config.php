    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme): void {
            ...
            $theme->asset()->container('header')->add('swiper-css', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css');
            $theme->asset()->container('header')->usePath()->add('equal-height-js', 'libraries/jquery.matchHeight-min.js');
            $theme->asset()->container('footer')->add('swiper-js', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js');
            $theme->asset()->container('footer')->usePath()->add('waypoints-js', 'libraries/jquery.waypoints.min.js');

            $theme->asset()->container('footer')->usePath()->add('app-js', 'js/app.js', [], [], '2.51.9');

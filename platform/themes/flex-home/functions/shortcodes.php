...
app()->booted(function (): void {
    ...
    if (is_plugin_active('real-estate')) {
        ...
        if (RealEstateHelper::isEnabledProjects()) {
            shortcode()->setAdminConfig('projects-by-locations', function (array $attributes) {
                ...
                return Html::style('vendor/core/core/base/libraries/tagify/tagify.css') .
                    ...
                    Theme::partial(
                        'short-codes.projects-by-locations-admin-config',
        ...
        add_shortcode('property-categories', __('Property Categories'), __('Property Categories'), function (Shortcode $shortcode) {
            $categories = \Botble\RealEstate\Models\Category::query()
                ->wherePublished()
            ...
            return Theme::partial('short-codes.property-categories', [
                'title' => $shortcode->title,
                'subtitle' => $shortcode->subtitle,
        ...
        shortcode()->setAdminConfig('property-categories', function (array $attributes) {
            return Theme::partial('short-codes.property-categories-admin-config', compact('attributes'));
        });
    }
